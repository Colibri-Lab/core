...
class ValidationHelper
{
	 ...
	 * @return boolean
	 */
	public static function ValidateBik(string $bik, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		$bik = (string)$bik;
		if (!$bik) {
	 ...
	 * @return boolean
	 */
	public static function ValidateInn(string $inn, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		$inn = (string)$inn;
		if (!$inn) {
	 ...
	 * @return boolean
	 */
	public static function ValidateKpp(string $kpp, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		$kpp = (string)$kpp;
		if (!$kpp) {
	 ...
	 * @return boolean
	 */
	public static function ValidateKs(string $ks, string $bik, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
	 ...
	 * @return boolean
	 */
	public static function ValidateOgrn(string $ogrn, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		$ogrn = (string)$ogrn;
		if (!$ogrn) {
	 ...
	 * @return boolean
	 */
	public static function ValidateOgrnip(string $ogrnip, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
	 ...
	 * @return boolean
	 */
	public static function ValidateRs(string $rs, string $bik, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		if (self::validateBik($bik, $error_message, $error_code)) {
			$rs = (string)$rs;
	 ...
	 * @return boolean
	 */
	public static function ValidateSnils(string $snils, mixed&$error_message = null, mixed&$error_code = null): bool
	{
		$result = false;
		$snils = (string)$snils;
		if (!$snils) {
